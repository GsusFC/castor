      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="relative">
          ...
          <input
            ...
            min={today}
            className="w-full h-10 pl-10 pr-3 rounded-md border border-border bg-card text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:inset-0 [&::-webkit-calendar-picker-indicator]:w-full [&::-webkit-calendar-picker-indicator]:h-full [&::-webkit-calendar-picker-indicator]:cursor-pointer"
          />
        </div>
        <div className="relative">
