  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-6 lg:gap-8 max-w-4xl xl:max-w-6xl mx-auto -mt-4 sm:-mt-6 md:-mt-8">
      ...
      <div className="w-full">
        {/* Header */}
        <div className="sticky z-40 pt-4 sm:pt-6 pb-4 bg-background/80 backdrop-blur-lg border-b border-border/50 lg:-mx-0 -mx-4 sm:-mx-6 md:-mx-8 px-4 sm:px-6 md:px-8 lg:px-0 top-14 sm:top-16">
